...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new_video/ios/Frameworks/ffmpegkit.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new_video/ios/Frameworks/libavcodec.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new_video/ios/Frameworks/libavdevice.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new_video/ios/Frameworks/libavfilter.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new_video/ios/Frameworks/libavformat.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new_video/ios/Frameworks/libavutil.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new_video/ios/Frameworks/libswresample.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new_video/ios/Frameworks/libswscale.framework"
