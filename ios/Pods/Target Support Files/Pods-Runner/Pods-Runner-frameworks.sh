...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/advertising_id/advertising_id.framework"
  ...
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new/ios/Frameworks/ffmpegkit.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new/ios/Frameworks/libavcodec.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new/ios/Frameworks/libavdevice.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new/ios/Frameworks/libavfilter.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new/ios/Frameworks/libavformat.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new/ios/Frameworks/libavutil.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new/ios/Frameworks/libswresample.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/ffmpeg_kit_flutter_new/ios/Frameworks/libswscale.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/kakao_flutter_sdk_auth/kakao_flutter_sdk_auth.framework"
