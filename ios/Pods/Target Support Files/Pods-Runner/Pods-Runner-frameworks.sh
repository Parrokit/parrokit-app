...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg_kit_flutter/ffmpeg_kit_ios_local/ffmpegkit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg_kit_flutter/ffmpeg_kit_ios_local/libavdevice.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg_kit_flutter/ffmpeg_kit_ios_local/libavcodec.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg_kit_flutter/ffmpeg_kit_ios_local/libavfilter.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg_kit_flutter/ffmpeg_kit_ios_local/libavformat.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg_kit_flutter/ffmpeg_kit_ios_local/libavutil.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg_kit_flutter/ffmpeg_kit_ios_local/libswresample.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ffmpeg_kit_flutter/ffmpeg_kit_ios_local/libswscale.framework"
fi
